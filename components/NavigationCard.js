...
export default function NavigationCard() {
  ...
  const nonActiveElementClasses =
    "hover:font-bold text-sm md:text-md flex gap-1 md:gap-3 py-2  my-2 hover:bg-blue-500 hover:bg-opacity-20 md:-mx-4 px-4 md:px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300 items-center";
  ...
  return (
    <Card>
      <div className="md:px-4 py-2 gap-0 flex md:gap-4 justify-between md:block">
